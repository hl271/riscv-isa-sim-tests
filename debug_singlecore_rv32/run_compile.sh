rm -rf spike32_*
riscv32-unknown-elf-gcc -g program/counting_loop.c -DDEFINE_MALLOC -DDEFINE_FREE program/entry.S program/init.c -DNHARTS=1 -I ../env -T ./spike32.lds -nostartfiles -mcmodel=medany -DXLEN=32 -o spike32_main -march=rv32imafdcv -mabi=ilp32
